    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-bold text-gray-800 mb-3">ระบบคำนวณราคาวัสดุ</h1>
          <p className="text-xl text-gray-600">เครื่องมือคำนวณราคาแม่นยำ ใช้งานง่าย</p>
        </div>
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl border border-white/50 p-8">
              ...
              <div className="mb-8">
                <h2 className="text-lg font-semibold text-gray-800 mb-4">ประเภทวัสดุ</h2>
                <div className="inline-flex bg-gradient-to-r from-gray-100 to-gray-200 rounded-2xl p-1.5 shadow-inner">
                  <button
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                ...
                <div className="md:col-span-2">
                  <label className="block text-sm font-semibold text-gray-700 mb-3">เลือกวัสดุ</label>
                  <select 
                    className="w-full px-4 py-4 border-2 border-gray-200 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all bg-white/80 shadow-sm hover:shadow-md"
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-3">ขนาดโครงสร้าง</label>
                  <select 
                    className="w-full px-4 py-4 border-2 border-gray-200 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all bg-white/80 shadow-sm hover:shadow-md"
                    value={selectedSize} 
              ...
              <div className="grid md:grid-cols-4 gap-6 mb-8">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-3">ความกว้าง (ม.)</label>
                  <input 
                    type="number" 
                    className="w-full px-4 py-4 border-2 border-gray-200 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all bg-white/80 shadow-sm hover:shadow-md"
                    placeholder="0.00"
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-3">ความยาว (ม.)</label>
                  <input 
                    type="number" 
                    className="w-full px-4 py-4 border-2 border-gray-200 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-500 transition-all bg-white/80 shadow-sm hover:shadow-md"
                    placeholder="0.00"
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-3">พื้นที่ (ตร.ม.)</label>
                  <div className="bg-gradient-to-r from-purple-50 to-pink-50 border-2 border-purple-200 rounded-2xl px-4 py-4 text-purple-800 font-bold text-center shadow-sm">
                    {area > 0 ? area.toFixed(2) : '0.00'}
                  </div>
                </div>

                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-3">ราคา/ตร.ม.</label>
                  <div className="bg-gradient-to-r from-emerald-50 to-teal-50 border-2 border-emerald-200 rounded-2xl px-4 py-4 text-emerald-800 font-bold text-center shadow-sm">
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                ...
                <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl p-6 border border-orange-200">
                  <label className="flex items-center mb-4">
                    <input 
                      type="checkbox" 
                      className="w-5 h-5 text-orange-600 border-orange-300 rounded-lg focus:ring-orange-500 mr-3"
                      checked={useCeiling} 
                      onChange={e => setUseCeiling(e.target.checked)}
                    />
                    <span className="text-lg font-semibold text-orange-800 flex items-center gap-2">
                  ...
                  <select 
                    disabled={!useCeiling}
                    className="w-full px-4 py-3 border-2 border-orange-200 rounded-xl disabled:bg-orange-100 disabled:text-orange-400 focus:ring-4 focus:ring-orange-100 focus:border-orange-500 transition-all bg-white/80"
                ...
                <div className="bg-gradient-to-r from-indigo-50 to-blue-50 rounded-2xl p-6 border border-indigo-200">
                  <label className="flex items-center mb-4">
                    <input 
                      type="checkbox" 
                      className="w-5 h-5 text-indigo-600 border-indigo-300 rounded-lg focus:ring-indigo-500 mr-3"
                      checked={useLouver} 
                  ...
                  <select 
                    disabled={!useLouver}
                    className="w-full px-4 py-3 border-2 border-indigo-200 rounded-xl disabled:bg-indigo-100 disabled:text-indigo-400 focus:ring-4 focus:ring-indigo-100 focus:border-indigo-500 transition-all bg-white/80"
              ...
              {/* Calculation Steps - Moved here */}
              {result && (
                <div className="bg-gradient-to-r from-slate-50 to-gray-50 rounded-2xl border-2 border-slate-200 p-6">
                  ...
                  <div className="bg-white rounded-xl p-5 border border-slate-200 shadow-sm">
                    <pre className="text-sm text-slate-700 whitespace-pre-line font-mono leading-relaxed">
                      {result.steps}
                    </pre>
                  </div>
                </div>
          ...
          <div className="space-y-6">
                  ...
                  {STRUCTURE_SIZES.map(size => {
                    ...
                    return (
                      <div key={size} className={`flex justify-between py-3 px-4 rounded-xl text-sm transition-all duration-200 ${
                        isSelected 
                          ? 'bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-300 font-bold shadow-md transform scale-105' 
                          : 'bg-gray-50 hover:bg-gray-100 border border-gray-200 hover:shadow-sm'
                      }`}>
                        <span className={isSelected ? 'text-blue-700' : 'text-gray-700'}>{size}</span>
            ...
            {result ? (
              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl border border-white/50 p-8 text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-700 mb-2">พร้อมคำนวณราคา</h3>
                <p className="text-gray-500">กรอกข้อมูลและกดปุ่มคำนวณ</p>
              </div>
            )}
              ...
              <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-xl border border-white/50 p-6">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between py-3 px-4 bg-gray-50 rounded-xl border border-gray-200">
                    <span className="text-gray-700 font-medium">วัสดุหลังคา</span>
                    <span className="font-bold text-gray-900">{formatPrice(result.materialCost)} ฿</span>
                  </div>
                  {result.ceilingCost && (
                    <div className="flex justify-between py-3 px-4 bg-orange-50 rounded-xl border border-orange-200">
                      <span className="text-orange-700 font-medium">งานฝ้า</span>
                      <span className="font-bold text-orange-900">{formatPrice(result.ceilingCost)} ฿</span>
                    </div>
                  )}
                  {result.louverCost && (
                    <div className="flex justify-between py-3 px-4 bg-indigo-50 rounded-xl border border-indigo-200">
                      <span className="text-indigo-700 font-medium">งานระแนง</span>
                      <span className="font-bold text-indigo-900">{formatPrice(result.louverCost)} ฿</span>
                    </div>
                  )}
